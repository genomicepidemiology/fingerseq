...
about['home'] = 'https://bitbucket.org/genomicepidemiology/fingerseq'
about['summary'] = 'fingerseq extracts basic information about sequence samples, such as the predicted technology, phred scale and whether the sample is paired end.'
